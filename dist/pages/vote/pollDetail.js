...
var Polldetail = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Polldetail, [{
    ...
    value: function componentDidMount() {
      ...
      var qInfo = _question.questionLst[qId];
      this.setState({
        questionId: qId,
    ...
    value: function _createData() {
      ...
      var _state = this.__state,
          ...
          questionTitle = _state.questionTitle,
          detailedInfo = _state.detailedInfo;


      var loopArray8 = this.__state.options.map(function (item, index) {
        item = {
