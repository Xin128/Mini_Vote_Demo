...
var Vote = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Vote() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Vote.__proto__ || Object.getPrototypeOf(Vote)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray5", "$compid__21", "$compid__22", "$compid__23", "$compid__24", "$compid__25", "$compid__26", "$compid__27", "options"], _this.config = {
  ...
  _createClass(Vote, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__22"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__22 = _genCompid4[0],
          $compid__22 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__23"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__23 = _genCompid6[0],
          $compid__23 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__24"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__24 = _genCompid8[0],
          $compid__24 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__25"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__25 = _genCompid10[0],
          $compid__25 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__26"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__26 = _genCompid12[0],
          $compid__26 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__27"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__27 = _genCompid14[0],
          $compid__27 = _genCompid14[1];

      var loopArray5 = this.__state.options.map(function (value, index) {
        value = {
          $original: (0, _taroWeapp.internal_get_original)(value)
        };

        var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "bzzzzzzzzz" + index, true),
            _genCompid16 = _slicedToArray(_genCompid15, 2),
            $prevCompid__20 = _genCompid16[0],
            $compid__20 = _genCompid16[1];
