...
var Vote = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Vote() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Vote.__proto__ || Object.getPrototypeOf(Vote)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray7", "$compid__30", "$compid__31", "$compid__32", "$compid__33", "$compid__34", "$compid__35", "$compid__36", "options"], _this.config = {
  ...
  _createClass(Vote, [{
    ...
    value: function _createData() {
      ...
      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__33"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__33 = _genCompid8[0],
          $compid__33 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__34"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__34 = _genCompid10[0],
          $compid__34 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__35"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__35 = _genCompid12[0],
          $compid__35 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__36"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__36 = _genCompid14[0],
          $compid__36 = _genCompid14[1];
      ...
      var loopArray7 = this.__state.options.map(function (value, index) {
        ...
        var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "gzzzzzzzzz" + index, true),
