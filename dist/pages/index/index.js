...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "anonymousState__temp6", "anonymousState__temp7", "anonymousState__temp10", "anonymousState__temp11", "loopArray345", "$compid__1293", "$compid__1294", "$compid__1295", "$compid__1296", "$compid__1297", "$compid__1298", "$compid__1299", "isShowQues", "scrollY", "isActive", "Threshold", "scrollAnimation", "recList", "hotList", "footerTip", "isShow", "searchVal", "focusList", "dragStyle", "downPullStyle", "downPullText", "creState", "pullState", "status", "userdb", "questiondb"], _this.showMack = function () {
      var that = _this;
      that.setState({
        isShow: true,
        searchVal: ''
  ...
  _createClass(Index, [{
    ...
    value: function _constructor() {
      ...
      var db = _taroWeapp2.default.cloud.database();
      ...
      this.state = {
        ...
        status: 'more',
        userdb: _taroWeapp2.default.cloud.database().collection("Users"),
        questiondb: _taroWeapp2.default.cloud.database().collection("Questions")
      };
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__1293"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__1293 = _genCompid2[0],
          $compid__1293 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__1294"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__1294 = _genCompid4[0],
          $compid__1294 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__1295"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__1295 = _genCompid6[0],
          $compid__1295 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__1296"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__1296 = _genCompid8[0],
          $compid__1296 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__1297"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__1297 = _genCompid10[0],
          $compid__1297 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__1298"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__1298 = _genCompid12[0],
          $compid__1298 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__1299"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__1299 = _genCompid14[0],
          $compid__1299 = _genCompid14[1];
      ...
      var _state = this.__state,
          ...
          userdb = _state.userdb,
          questiondb = _state.questiondb;

      var tabList = [{ title: '推荐' }, { title: '热榜' }];
      var Threshold = 50;
      var scrollAnimation = true;
      userdb.limit(2).get().then(function (res) {
        console.log(res);
        console.log(res.data);
        res.data.map(function (entity) {
          return console.log(entity.userName);
        });
      });
      ...
      var loopArray345 = hotList.map(function (item, index) {
        item = {
      ...
      }, $compid__1293, $prevCompid__1293);
      _taroWeapp.propsManager.set({
        "current": isActive,
        "index": 0
      }, $compid__1294, $prevCompid__1294);
      _taroWeapp.propsManager.set({
        "content": downPullText
      }, $compid__1295, $prevCompid__1295);
      _taroWeapp.propsManager.set({
        "status": status,
        "moreText": "\u67E5\u770B\u6570\u636E",
        "loadingText": "\u6570\u636E\u52A0\u8F7D\u4E2D...",
      ...
      }, $compid__1296, $prevCompid__1296);
      _taroWeapp.propsManager.set({
        "current": isActive,
        "index": 1
      }, $compid__1297, $prevCompid__1297);
      _taroWeapp.propsManager.set({
        "content": downPullText
      }, $compid__1298, $prevCompid__1298);
      _taroWeapp.propsManager.set({
        "status": status,
        "moreText": "\u67E5\u770B\u6570\u636E",
        "loadingText": "\u6570\u636E\u52A0\u8F7D\u4E2D...",
      ...
      Object.assign(this.__state, {
        ...
        $compid__1293: $compid__1293,
        $compid__1294: $compid__1294,
        $compid__1295: $compid__1295,
        $compid__1296: $compid__1296,
        $compid__1297: $compid__1297,
        $compid__1298: $compid__1298,
        $compid__1299: $compid__1299,
        Threshold: Threshold,
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = ["addData", "showQuesMask", "hideQuesMask", "touchStart", "touchRecMove", "touchEnd", "getRecommendList", "onReachBottom", "goTitleDetail", "goContentDetail", "touchHotMove", "getHotList"], _class.$$componentPath = "pages/index/index", _temp2);
