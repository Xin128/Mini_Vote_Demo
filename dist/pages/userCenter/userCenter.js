...
var Usercenter = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Usercenter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Usercenter.__proto__ || Object.getPrototypeOf(Usercenter)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.config = {
  ...
  _createClass(Usercenter, [{
    ...
    value: function _constructor(props) {
      _get(Usercenter.prototype.__proto__ || Object.getPrototypeOf(Usercenter.prototype), '_constructor', this).call(this, props);
