...
export default class Vote extends Taro.Component {
  ...
  render() {
    return <AtForm onSubmit={this.onSubmit.bind(this)} onReset={this.onReset.bind(this)}>
        <AtInput name="value" title="投票标题" type="text" placeholder="CS本科Offer怎么选" value={this.state.value} onChange={this.handleChange.bind(this)} />
      <AtInput name="value" title="" type="text" placeholder="详细问题描述" value={this.state.value} onChange={this.handleChange.bind(this)} />
      <AtSwitch title="允许多选" checked={this.state.value} onChange={this.handleChange} />

      {this.state.options.map((value, index) => {
        return <AtInput name="value" title="" type="text" placeholder={index} value={value} onChange={this.handleChange.bind(this)} />;
      })}
